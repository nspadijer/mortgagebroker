...
function analyzeQuestion(question) {
    ...
    // Edge case detection
    const isEdgeCase = q.includes("not from") || q.includes("non-us") || q.includes("foreign") || q.includes("immigrant") ||
...
function buildFollowUps(category) {
    const followUps = [];
    // Category-specific follow-ups
    switch (category) {
        case "citizenship":
            followUps.push("What documents do I need as a non-U.S. citizen?", "What are ITIN loans and how do they work?", "Do I qualify for FHA with a work visa?");
            break;
        case "income_verification":
            followUps.push("What are bank statement loans?", "How do I start filing taxes to qualify?", "What if I'm self-employed with irregular income?");
            break;
        case "credit":
            followUps.push("How can I improve my credit score quickly?", "What if I have no credit history at all?", "Do you offer manual underwriting?");
            break;
        default:
            followUps.push("Would you like to calculate your estimated monthly payment?", "What are current interest rates?", "Ready to discuss the pre-qualification process?");
    }
