...
function registerResources(server, widgetHtml) {
    server.registerResource("mortgagebroker-widget", outputTemplate, {}, async () => ({
        contents: [
            {
                uri: outputTemplate,
...
function registerTools(server) {
    server.registerTool("mortgageAdvisor", {
    ...
    server.registerTool("mortgageCalculator", {
    ...
    server.registerTool("submitLead", {
        title: "Capture lead",
    ...
    server.registerTool("startPrequalSession", {
...
function createMortgageServer(widgetHtml) {
